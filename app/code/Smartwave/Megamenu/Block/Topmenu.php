...
class Topmenu extends \Magento\Framework\View\Element\Template
{
    ...
    public function getCustomBlockHtml($type='after') {
        ...
        $block_ids = $this->getData('custom_block') ? $this->getData('custom_block') : $this->_megamenuConfig['custom_links']['staticblock_'.$type];
    ...
    public function getMegamenuCustomHtml(){
      $html = '';
      $html .= $this->getCustomBlockHtml();
      return $html;
    }
}
